<html>
		   ...
		   <img src="IMAGES/map.PNG" style="margin-left:60px; margin-top:0px;margin-left:100px;" height="200" width="450" />
		   <p style="margin-left:100px; font-family:Vladimir Script; font-size:23px;margin-top:10px;">Coffee House.<br/>
           						 SCO 86, Sector 17 C<br/>
								  Chandigrah,  Freephone: +1 800 559 6580<br/>
									Telephone: 0172 601938<br/>
										 <a style="text-decoration:none;color:#000000;href="#">E-mail: mail@ravesh.org</a></p>
		   </div>
